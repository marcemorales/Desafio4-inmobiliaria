...
const propiedadesAlquilerContainer = document.getElementById('alquiler').querySelector('.row');

function renderizarPropiedades(propiedades, container, limite = 3) {
  container.innerHTML = '';
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="${propiedad.smoke ? 'text-success' : 'text-danger'}">
            <i class="${propiedad.smoke ? 'fa-solid fa-smoking' : 'fas fa-smoking-ban'}"></i> ${propiedad.smoke ? 'Permitido fumar' : 'No se permite fumar'}
          </p>
...
renderizarPropiedades(propiedades_alquiler, propiedadesAlquilerContainer);
